# Home - FHIR Hackathon 2025 v1.4.5
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/hackathon/2025/ImplementationGuide/hl7.fhir.no.hackathon.2025 | *Version*:1.4.5 |
| Draft as of 2026-02-15 | *Computable Name*:FHIRHackathon2025 |
...
Please visit the result pages in this IG for documentation of results from the Hackathon. You can also read a short summary in the [presentation](FHIR Hackathon 2025 oppsummering-alle.pdf).
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-15T21:08:34+00:00",
  "publisher" : "HL7 Norge",
  "contact" : [
    {
      "name" : "HL7 Norge",
      ...
      "page" : [
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "resultater-bilder.html"
            }
          ],
          "nameUrl" : "resultater-bilder.html",
          "title" : "Resultater Bilder",
          "generation" : "markdown"
        },
        {
          "extension" : [
