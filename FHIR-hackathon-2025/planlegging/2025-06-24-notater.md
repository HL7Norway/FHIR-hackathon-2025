...
Nino og bedre delt kan inn og Oslo kommune kan ut

FHIR server lage nytt API
...
IG authoring og bruk av nordic terminologiserver.
...
Hva trenger de av forkunnskaper, introtekst

* Hva laster du ned på forhånd.
* Utvikler - PC
* Skeleton med ting som man trenger for å utvikle noe så de kan teste på forhånd.
* EHIN Workshop - siden det er utvikling

Agenda

* HvelseID på måledata skal vi ha det som fokus
* Da må HelseID være en intro - Gaute sjekker med Sigurd
* Terminologi - skal vi bruke GUI på Ontoserver og spør CSIRO om å gi intro til Ontoserver
  * Kate Mathias kontakter CSIRO om dette.
* Måledata API - NHN går igjennom
* OKT API kan gå igjennom hvordan du FHIR ifiserer et proprietært API
* Generell intro FHIR - hvordan skrive IG del av generell intro Øyvind Thomas og Espen
  * Kan nevne EHDS arbeidet.
